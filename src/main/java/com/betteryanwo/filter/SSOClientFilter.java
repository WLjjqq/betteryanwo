...
import com.betteryanwo.exception.ServiceException;
import com.betteryanwo.service.UsersService;
import com.betteryanwo.util.RestTemplateUtil;
...
public class SSOClientFilter extends SSOFilter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        userService = wac.getBean(UsersService.class);
    }
    ...
    public void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        Users user = userService.getById(12L);
        SessionUtil.setSessionUser(request, SessionUtil.convertToSessionUsers(user));
