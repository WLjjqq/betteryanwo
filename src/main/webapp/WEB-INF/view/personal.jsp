				...
				<div class="col-md-10 col-md-offset-1 animate-box">
					<div class="owl-carousel owl-carousel-fullwidth product-carousel" id="lunbo">
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="/statics/images/product-single-1.jpg" style="width: 400px;height: 400px;" alt="user">
								</figure>
							</div>
						</div>
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="/statics/images/product-single-2.jpg" style="width: 400px;height: 400px;" alt="user">
								</figure>
							</div>
						</div>
					</div>
					<div class="row animate-box" id="title">
						<div class="col-md-8 col-md-offset-2 text-center fh5co-heading" id="title">
							...
							<p><span class="price" style="font-size: 16px;">RMB:${product.GPrice}</span></p>
							<p>
